...
# from tensorflow.python.keras.optimizer_v1 import RMSprop, Adam
...
class A2CAgent:
    ...
    def __init__(self, env_name):
        ...
        # self.env.reset()  # for FrozenLake-v1
        # self.env.render()
...
if __name__ == "__main__":
    ...
    # env_name = "FrozenLake-v1"  # AttributeErro: 'FrozenLakeEnv' object has no attribute 'lastaction'
