# works for CartPole
# atari does not work -> RuntimeError: mat1 and mat2 shapes cannot be multiplied (33600x3 and 210x64) --> SpaceInvaders
# IndexError: tuple index out of range --> FrozenLake
